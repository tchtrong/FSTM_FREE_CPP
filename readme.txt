...
------------------------------------------------------------------------
This is a dimension-free implementation of Fully sparse topic models (FSTM). 
In other words, except the initial step, all other steps in the learning algorithm 
